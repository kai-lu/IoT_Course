...
3. （2021-05-06补充）近半个学期过去，个人觉得，有些同学的学习热情和能力，应该完全可以胜任复现结果类型的工作。现在对大作业要求做一点调整：愿意沿用之前方案的可以继续沿用，不受影响，***但请在第15周之前务必确定主题、并填写在QQ群文件中***；愿意做复现工作的，也可以提交一份复现工作报告（最多两人一组，按照贡献比例分配成绩。初步算法为：假设1个人报告满分100，两人一组的总满分为200分，按照贡献比例分配。必须是真实贡献比例。）。参考论文只可以出自高质期刊。可以自选，也可以等晚些时候，我联系专门做物联网方向的老师来提供。有意这么做的，请尽早跟我联系（***第15周之前务必确定***），看看我可以提供什么帮助。
